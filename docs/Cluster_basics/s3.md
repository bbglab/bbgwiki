...
In addition to command-line access from the IRB cluster, you can also
access S3 via Open OnDemand in read-only mode, you can browse and download files but cannot
modify or upload from this interface.
